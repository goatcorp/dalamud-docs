...
Now most use `ref struct` construct, this will prevent boxing and is in general less costly than a class, 
only `Push...` functions are still classes that can be taken across scope.
