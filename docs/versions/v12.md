...
- [Dalamud.NET.Sdk v12.0.1](https://www.nuget.org/packages/Dalamud.NET.Sdk/12.0.1)
    - To upgrade, change the header of your plugins' `.csproj` file: `<Project Sdk="Dalamud.NET.Sdk/12.0.1">`
