...
With version 14 of the SDK, it is now possible to specify manifest properties directly
in your .csproj file. You no longer necessarily need a JSON manifest.
