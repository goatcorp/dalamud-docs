...
.NET SDK 10.0.101 and Visual Studio 2026 or Rider 2025.3 are required to develop against this release.
The 10.0.100 SDK is not recommended as it has problems restoring packages.
...
Version information for Dalamud should now be obtained via `IDalamudPluginInterface.GetDalamudVersion()`,
instead of the functions defined in the `Utils` class, which have been removed.
