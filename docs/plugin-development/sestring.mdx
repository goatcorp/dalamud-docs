...
- \[0] Integer Expression: Hour (in Japan Standard Time)
- \[1] Integer Expression: Weekday (0-6 = Sunday to Saturday, 7 = Special case
  for daily resets)
...
→ Sets the contextual time to next Tuesday, 8 am UTC.
...
→ Prints `03.03. at 09:00` (at time of writing, in UTC+1).
...
<details>
  <summary>Expand for a list available icons (as of Patch <div className="gfd-game-version"></div>)</summary>

| Id  | Icon                                          |
| --- | --------------------------------------------- |
| 1   | <div className="gfd-icon gfd-icon-1"></div>   |
| 2   | <div className="gfd-icon gfd-icon-2"></div>   |
| 3   | <div className="gfd-icon gfd-icon-3"></div>   |
| 4   | <div className="gfd-icon gfd-icon-4"></div>   |
| 5   | <div className="gfd-icon gfd-icon-5"></div>   |
| 6   | <div className="gfd-icon gfd-icon-6"></div>   |
| 7   | <div className="gfd-icon gfd-icon-7"></div>   |
| 8   | <div className="gfd-icon gfd-icon-8"></div>   |
| 9   | <div className="gfd-icon gfd-icon-9"></div>   |
| 10  | <div className="gfd-icon gfd-icon-10"></div>  |
| 11  | <div className="gfd-icon gfd-icon-11"></div>  |
| 12  | <div className="gfd-icon gfd-icon-12"></div>  |
| 13  | <div className="gfd-icon gfd-icon-13"></div>  |
| 14  | <div className="gfd-icon gfd-icon-14"></div>  |
| 15  | <div className="gfd-icon gfd-icon-15"></div>  |
| 16  | <div className="gfd-icon gfd-icon-16"></div>  |
| 17  | <div className="gfd-icon gfd-icon-17"></div>  |
| 18  | <div className="gfd-icon gfd-icon-18"></div>  |
| 19  | <div className="gfd-icon gfd-icon-19"></div>  |
| 20  | <div className="gfd-icon gfd-icon-20"></div>  |
| 21  | <div className="gfd-icon gfd-icon-21"></div>  |
| 22  | <div className="gfd-icon gfd-icon-22"></div>  |
| 23  | <div className="gfd-icon gfd-icon-23"></div>  |
| 24  | <div className="gfd-icon gfd-icon-24"></div>  |
| 25  | <div className="gfd-icon gfd-icon-25"></div>  |
| 51  | <div className="gfd-icon gfd-icon-51"></div>  |
| 52  | <div className="gfd-icon gfd-icon-52"></div>  |
| 53  | <div className="gfd-icon gfd-icon-53"></div>  |
| 54  | <div className="gfd-icon gfd-icon-54"></div>  |
| 55  | <div className="gfd-icon gfd-icon-55"></div>  |
| 56  | <div className="gfd-icon gfd-icon-56"></div>  |
| 57  | <div className="gfd-icon gfd-icon-57"></div>  |
| 58  | <div className="gfd-icon gfd-icon-58"></div>  |
| 59  | <div className="gfd-icon gfd-icon-59"></div>  |
| 60  | <div className="gfd-icon gfd-icon-60"></div>  |
| 61  | <div className="gfd-icon gfd-icon-61"></div>  |
| 62  | <div className="gfd-icon gfd-icon-62"></div>  |
| 63  | <div className="gfd-icon gfd-icon-63"></div>  |
| 64  | <div className="gfd-icon gfd-icon-64"></div>  |
| 65  | <div className="gfd-icon gfd-icon-65"></div>  |
| 66  | <div className="gfd-icon gfd-icon-66"></div>  |
| 67  | <div className="gfd-icon gfd-icon-67"></div>  |
| 68  | <div className="gfd-icon gfd-icon-68"></div>  |
| 70  | <div className="gfd-icon gfd-icon-70"></div>  |
| 71  | <div className="gfd-icon gfd-icon-71"></div>  |
| 72  | <div className="gfd-icon gfd-icon-72"></div>  |
| 73  | <div className="gfd-icon gfd-icon-73"></div>  |
| 74  | <div className="gfd-icon gfd-icon-74"></div>  |
| 75  | <div className="gfd-icon gfd-icon-75"></div>  |
| 76  | <div className="gfd-icon gfd-icon-76"></div>  |
| 77  | <div className="gfd-icon gfd-icon-77"></div>  |
| 78  | <div className="gfd-icon gfd-icon-78"></div>  |
| 79  | <div className="gfd-icon gfd-icon-79"></div>  |
| 80  | <div className="gfd-icon gfd-icon-80"></div>  |
| 81  | <div className="gfd-icon gfd-icon-81"></div>  |
| 82  | <div className="gfd-icon gfd-icon-82"></div>  |
| 83  | <div className="gfd-icon gfd-icon-83"></div>  |
| 84  | <div className="gfd-icon gfd-icon-84"></div>  |
| 85  | <div className="gfd-icon gfd-icon-85"></div>  |
| 86  | <div className="gfd-icon gfd-icon-86"></div>  |
| 87  | <div className="gfd-icon gfd-icon-87"></div>  |
| 88  | <div className="gfd-icon gfd-icon-88"></div>  |
| 89  | <div className="gfd-icon gfd-icon-89"></div>  |
| 90  | <div className="gfd-icon gfd-icon-90"></div>  |
| 91  | <div className="gfd-icon gfd-icon-91"></div>  |
| 92  | <div className="gfd-icon gfd-icon-92"></div>  |
| 93  | <div className="gfd-icon gfd-icon-93"></div>  |
| 94  | <div className="gfd-icon gfd-icon-94"></div>  |
| 95  | <div className="gfd-icon gfd-icon-95"></div>  |
| 96  | <div className="gfd-icon gfd-icon-96"></div>  |
| 97  | <div className="gfd-icon gfd-icon-97"></div>  |
| 98  | <div className="gfd-icon gfd-icon-98"></div>  |
| 99  | <div className="gfd-icon gfd-icon-99"></div>  |
| 100 | <div className="gfd-icon gfd-icon-100"></div> |
| 101 | <div className="gfd-icon gfd-icon-101"></div> |
| 102 | <div className="gfd-icon gfd-icon-102"></div> |
| 103 | <div className="gfd-icon gfd-icon-103"></div> |
| 104 | <div className="gfd-icon gfd-icon-104"></div> |
| 105 | <div className="gfd-icon gfd-icon-105"></div> |
| 106 | <div className="gfd-icon gfd-icon-106"></div> |
| 107 | <div className="gfd-icon gfd-icon-107"></div> |
| 108 | <div className="gfd-icon gfd-icon-108"></div> |
| 109 | <div className="gfd-icon gfd-icon-109"></div> |
| 110 | <div className="gfd-icon gfd-icon-110"></div> |
| 111 | <div className="gfd-icon gfd-icon-111"></div> |
| 112 | <div className="gfd-icon gfd-icon-112"></div> |
| 113 | <div className="gfd-icon gfd-icon-113"></div> |
| 114 | <div className="gfd-icon gfd-icon-114"></div> |
| 115 | <div className="gfd-icon gfd-icon-115"></div> |
| 116 | <div className="gfd-icon gfd-icon-116"></div> |
| 117 | <div className="gfd-icon gfd-icon-117"></div> |
| 118 | <div className="gfd-icon gfd-icon-118"></div> |
| 119 | <div className="gfd-icon gfd-icon-119"></div> |
| 120 | <div className="gfd-icon gfd-icon-120"></div> |
| 121 | <div className="gfd-icon gfd-icon-121"></div> |
| 122 | <div className="gfd-icon gfd-icon-122"></div> |
| 124 | <div className="gfd-icon gfd-icon-124"></div> |
| 125 | <div className="gfd-icon gfd-icon-125"></div> |
| 126 | <div className="gfd-icon gfd-icon-126"></div> |
| 127 | <div className="gfd-icon gfd-icon-127"></div> |
| 128 | <div className="gfd-icon gfd-icon-128"></div> |
| 129 | <div className="gfd-icon gfd-icon-129"></div> |
| 130 | <div className="gfd-icon gfd-icon-130"></div> |
| 131 | <div className="gfd-icon gfd-icon-131"></div> |
| 132 | <div className="gfd-icon gfd-icon-132"></div> |
| 133 | <div className="gfd-icon gfd-icon-133"></div> |
| 134 | <div className="gfd-icon gfd-icon-134"></div> |
| 135 | <div className="gfd-icon gfd-icon-135"></div> |
| 136 | <div className="gfd-icon gfd-icon-136"></div> |
| 137 | <div className="gfd-icon gfd-icon-137"></div> |
| 138 | <div className="gfd-icon gfd-icon-138"></div> |
| 139 | <div className="gfd-icon gfd-icon-139"></div> |
| 140 | <div className="gfd-icon gfd-icon-140"></div> |
| 141 | <div className="gfd-icon gfd-icon-141"></div> |
| 142 | <div className="gfd-icon gfd-icon-142"></div> |
| 143 | <div className="gfd-icon gfd-icon-143"></div> |
| 144 | <div className="gfd-icon gfd-icon-144"></div> |
| 145 | <div className="gfd-icon gfd-icon-145"></div> |
| 146 | <div className="gfd-icon gfd-icon-146"></div> |
| 147 | <div className="gfd-icon gfd-icon-147"></div> |
| 148 | <div className="gfd-icon gfd-icon-148"></div> |
| 149 | <div className="gfd-icon gfd-icon-149"></div> |
| 150 | <div className="gfd-icon gfd-icon-150"></div> |
| 151 | <div className="gfd-icon gfd-icon-151"></div> |
| 152 | <div className="gfd-icon gfd-icon-152"></div> |
| 153 | <div className="gfd-icon gfd-icon-153"></div> |
| 154 | <div className="gfd-icon gfd-icon-154"></div> |
| 155 | <div className="gfd-icon gfd-icon-155"></div> |
| 156 | <div className="gfd-icon gfd-icon-156"></div> |
| 157 | <div className="gfd-icon gfd-icon-157"></div> |
| 158 | <div className="gfd-icon gfd-icon-158"></div> |
| 159 | <div className="gfd-icon gfd-icon-159"></div> |
| 160 | <div className="gfd-icon gfd-icon-160"></div> |
| 161 | <div className="gfd-icon gfd-icon-161"></div> |
| 162 | <div className="gfd-icon gfd-icon-162"></div> |
| 163 | <div className="gfd-icon gfd-icon-163"></div> |
| 164 | <div className="gfd-icon gfd-icon-164"></div> |
| 165 | <div className="gfd-icon gfd-icon-165"></div> |
| 166 | <div className="gfd-icon gfd-icon-166"></div> |
| 167 | <div className="gfd-icon gfd-icon-167"></div> |
| 168 | <div className="gfd-icon gfd-icon-168"></div> |
| 169 | <div className="gfd-icon gfd-icon-169"></div> |
| 170 | <div className="gfd-icon gfd-icon-170"></div> |
| 171 | <div className="gfd-icon gfd-icon-171"></div> |
| 172 | <div className="gfd-icon gfd-icon-172"></div> |
| 173 | <div className="gfd-icon gfd-icon-173"></div> |
| 174 | <div className="gfd-icon gfd-icon-174"></div> |
| 175 | <div className="gfd-icon gfd-icon-175"></div> |
| 176 | <div className="gfd-icon gfd-icon-176"></div> |
| 177 | <div className="gfd-icon gfd-icon-177"></div> |
| 178 | <div className="gfd-icon gfd-icon-178"></div> |
| 179 | <div className="gfd-icon gfd-icon-179"></div> |
| 180 | <div className="gfd-icon gfd-icon-180"></div> |
| 181 | <div className="gfd-icon gfd-icon-181"></div> |
| 182 | <div className="gfd-icon gfd-icon-182"></div> |
