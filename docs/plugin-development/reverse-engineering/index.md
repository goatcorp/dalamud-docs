...
bindings that effectively allow plugins to use the game as a library. Docs can
be found [here](https://ffxiv.wildwolf.dev), however this documentation is
incomplete and plugin developers will inevitably need to reverse engineer the
